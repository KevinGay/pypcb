...
#define __PYX_HAVE__pypcb__textDetector__cpu_nms
#define __PYX_HAVE_API__pypcb__textDetector__cpu_nms
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
static const char *__pyx_f[] = {
  "pypcb/textDetector/cpu_nms.pyx",
  "__init__.pxd",
  "type.pxd",
};
...
/* Module declarations from 'pypcb.textDetector.cpu_nms' */
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_5pypcb_12textDetector_7cpu_nms_max(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_5pypcb_12textDetector_7cpu_nms_min(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int_t = { "int_t", NULL, sizeof(__pyx_t_5numpy_int_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_int_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_int_t), 0 };
#define __Pyx_MODULE_NAME "pypcb.textDetector.cpu_nms"
int __pyx_module_is_main_pypcb__textDetector__cpu_nms = 0;

/* Implementation of 'pypcb.textDetector.cpu_nms' */
...
static const char __pyx_k_pypcb_textDetector_cpu_nms[] = "pypcb.textDetector.cpu_nms";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_home_mahalingamg_Dropbox_pypcb[] = "/home/mahalingamg/Dropbox/pypcb/textDetector/cpu_nms.pyx";
...
static PyObject *__pyx_kp_s_home_mahalingamg_Dropbox_pypcb;
...
static PyObject *__pyx_n_s_pypcb_textDetector_cpu_nms;
...
static PyObject *__pyx_pf_5pypcb_12textDetector_7cpu_nms_cpu_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh); /* proto */
...
/* "pypcb/textDetector/cpu_nms.pyx":11
 * cimport numpy as np
 * 
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_5pypcb_12textDetector_7cpu_nms_max(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("max", 0);

  /* "pypcb/textDetector/cpu_nms.pyx":12
 * 
 * cdef inline np.float32_t max(np.float32_t a, np.float32_t b):
 *     return a if a >= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "pypcb/textDetector/cpu_nms.pyx":14
 *     return a if a >= b else b
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):             # <<<<<<<<<<<<<<
 *     return a if a <= b else b
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_5pypcb_12textDetector_7cpu_nms_min(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("min", 0);

  /* "pypcb/textDetector/cpu_nms.pyx":15
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):
 *     return a if a <= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "pypcb/textDetector/cpu_nms.pyx":17
 *     return a if a <= b else b
 * 
 * def cpu_nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_5pypcb_12textDetector_7cpu_nms_1cpu_nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5pypcb_12textDetector_7cpu_nms_1cpu_nms = {"cpu_nms", (PyCFunction)__pyx_pw_5pypcb_12textDetector_7cpu_nms_1cpu_nms, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5pypcb_12textDetector_7cpu_nms_1cpu_nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pypcb.textDetector.cpu_nms.cpu_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_5pypcb_12textDetector_7cpu_nms_cpu_nms(__pyx_self, __pyx_v_dets, __pyx_v_thresh);
...
static PyObject *__pyx_pf_5pypcb_12textDetector_7cpu_nms_cpu_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh) {
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":18
 * 
 * def cpu_nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":19
 * def cpu_nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":20
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":21
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":22
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":24
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":25
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":27
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 * 
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":29
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = \
 *             np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":42
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":43
 * 
 *     keep = []
 *     for _i in range(ndets):             # <<<<<<<<<<<<<<
 *         i = order[_i]
 ...
 */
  ...
  for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":44
 *     keep = []
 *     for _i in range(ndets):
 *         i = order[_i]             # <<<<<<<<<<<<<<
 *         if suppressed[i] == 1:
 ...
 */
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":45
 *     for _i in range(ndets):
 *         i = order[_i]
 *         if suppressed[i] == 1:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_19) {
      ...
      /* "pypcb/textDetector/cpu_nms.pyx":46
 *         i = order[_i]
 *         if suppressed[i] == 1:
 *             continue             # <<<<<<<<<<<<<<
 *         keep.append(i)
 ...
 */
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":47
 *         if suppressed[i] == 1:
 *             continue
 *         keep.append(i)             # <<<<<<<<<<<<<<
 *         ix1 = x1[i]
 ...
 */
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":48
 *             continue
 *         keep.append(i)
 *         ix1 = x1[i]             # <<<<<<<<<<<<<<
 *         iy1 = y1[i]
 ...
 */
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":49
 *         keep.append(i)
 *         ix1 = x1[i]
 *         iy1 = y1[i]             # <<<<<<<<<<<<<<
 *         ix2 = x2[i]
 ...
 */
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":50
 *         ix1 = x1[i]
 *         iy1 = y1[i]
 *         ix2 = x2[i]             # <<<<<<<<<<<<<<
 *         iy2 = y2[i]
 ...
 */
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":51
 *         iy1 = y1[i]
 *         ix2 = x2[i]
 *         iy2 = y2[i]             # <<<<<<<<<<<<<<
 *         iarea = areas[i]
 ...
 */
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":52
 *         ix2 = x2[i]
 *         iy2 = y2[i]
 *         iarea = areas[i]             # <<<<<<<<<<<<<<
 *         for _j in range(_i + 1, ndets):
 ...
 */
    ...
    /* "pypcb/textDetector/cpu_nms.pyx":53
 *         iy2 = y2[i]
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):             # <<<<<<<<<<<<<<
 *             j = order[_j]
 ...
 */
    ...
    for (__pyx_t_26 = (__pyx_v__i + 1); __pyx_t_26 < __pyx_t_17; __pyx_t_26+=1) {
      ...
      /* "pypcb/textDetector/cpu_nms.pyx":54
 *         iarea = areas[i]
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]             # <<<<<<<<<<<<<<
 *             if suppressed[j] == 1:
 ...
 */
      ...
      /* "pypcb/textDetector/cpu_nms.pyx":55
 *         for _j in range(_i + 1, ndets):
 *             j = order[_j]
 *             if suppressed[j] == 1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_19) {
        ...
        /* "pypcb/textDetector/cpu_nms.pyx":56
 *             j = order[_j]
 *             if suppressed[j] == 1:
 *                 continue             # <<<<<<<<<<<<<<
 *             xx1 = max(ix1, x1[j])
 ...
 */
      ...
      /* "pypcb/textDetector/cpu_nms.pyx":57
 *             if suppressed[j] == 1:
 *                 continue
 *             xx1 = max(ix1, x1[j])             # <<<<<<<<<<<<<<
 *             yy1 = max(iy1, y1[j])
 ...
 */
      ...
      __pyx_v_xx1 = __pyx_f_5pypcb_12textDetector_7cpu_nms_max(__pyx_v_ix1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x1.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_x1.diminfo[0].strides)));

      /* "pypcb/textDetector/cpu_nms.pyx":58
 *                 continue
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])             # <<<<<<<<<<<<<<
 *             xx2 = min(ix2, x2[j])
 ...
 */
      ...
      __pyx_v_yy1 = __pyx_f_5pypcb_12textDetector_7cpu_nms_max(__pyx_v_iy1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y1.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_y1.diminfo[0].strides)));

      /* "pypcb/textDetector/cpu_nms.pyx":59
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])             # <<<<<<<<<<<<<<
 *             yy2 = min(iy2, y2[j])
 ...
 */
      ...
      __pyx_v_xx2 = __pyx_f_5pypcb_12textDetector_7cpu_nms_min(__pyx_v_ix2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x2.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_x2.diminfo[0].strides)));

      /* "pypcb/textDetector/cpu_nms.pyx":60
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])             # <<<<<<<<<<<<<<
 *             w = max(0.0, xx2 - xx1 + 1)
 ...
 */
      ...
      __pyx_v_yy2 = __pyx_f_5pypcb_12textDetector_7cpu_nms_min(__pyx_v_iy2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y2.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_y2.diminfo[0].strides)));

      /* "pypcb/textDetector/cpu_nms.pyx":61
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)             # <<<<<<<<<<<<<<
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 */
      __pyx_v_w = __pyx_f_5pypcb_12textDetector_7cpu_nms_max(0.0, ((__pyx_v_xx2 - __pyx_v_xx1) + 1.0));

      /* "pypcb/textDetector/cpu_nms.pyx":62
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)             # <<<<<<<<<<<<<<
 *             inter = w * h
 ...
 */
      __pyx_v_h = __pyx_f_5pypcb_12textDetector_7cpu_nms_max(0.0, ((__pyx_v_yy2 - __pyx_v_yy1) + 1.0));

      /* "pypcb/textDetector/cpu_nms.pyx":63
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h             # <<<<<<<<<<<<<<
 *             ovr = inter / (iarea + areas[j] - inter)
 ...
 */
      ...
      /* "pypcb/textDetector/cpu_nms.pyx":64
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)             # <<<<<<<<<<<<<<
 *             if ovr >= thresh:
 ...
 */
      ...
      /* "pypcb/textDetector/cpu_nms.pyx":65
 *             inter = w * h
 *             ovr = inter / (iarea + areas[j] - inter)
 *             if ovr >= thresh:             # <<<<<<<<<<<<<<
 *                 suppressed[j] = 1
 ...
 */
      ...
      if (__pyx_t_19) {
        ...
        /* "pypcb/textDetector/cpu_nms.pyx":66
 *             ovr = inter / (iarea + areas[j] - inter)
 *             if ovr >= thresh:
 *                 suppressed[j] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":68
 *                 suppressed[j] = 1
 * 
 *     return keep             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_home_mahalingamg_Dropbox_pypcb, __pyx_k_home_mahalingamg_Dropbox_pypcb, sizeof(__pyx_k_home_mahalingamg_Dropbox_pypcb), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_pypcb_textDetector_cpu_nms, __pyx_k_pypcb_textDetector_cpu_nms, sizeof(__pyx_k_pypcb_textDetector_cpu_nms), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(2, 0, 29, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_mahalingamg_Dropbox_pypcb, __pyx_n_s_cpu_nms, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_pypcb__textDetector__cpu_nms) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pypcb.textDetector.cpu_nms")) {
      if (unlikely(PyDict_SetItemString(modules, "pypcb.textDetector.cpu_nms", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pypcb/textDetector/cpu_nms.pyx":8
 * # --------------------------------------------------------
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5pypcb_12textDetector_7cpu_nms_1cpu_nms, NULL, __pyx_n_s_pypcb_textDetector_cpu_nms); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cpu_nms, __pyx_t_1) < 0) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pypcb/textDetector/cpu_nms.pyx":1
 * # --------------------------------------------------------             # <<<<<<<<<<<<<<
 * # Fast R-CNN
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pypcb.textDetector.cpu_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pypcb.textDetector.cpu_nms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
